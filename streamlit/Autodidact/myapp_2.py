...
def set_task():
    setlist = sorted(list(All_Conceptdata.loc[All_Conceptdata['set_frac']>0.1].sort_values(by = ['Centrality','set_frac'],ascending=[False]*2).iloc[0:60].loc[:,'MCForm']))
...
def phen_task():
    ...
    rel_list = ["promotes","inhibits","follows","is followed by","is directly associated with","is inversely associated with","competes with","causes","is caused by",'never occurs with','cooccurs with','is a step in','contains as step','is a type of','is an instance of']
